...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if ([fullName, username, email, password].some((filed) => filed?.trim() === "")) {
        throw new ApiError(400, "User with same username and email already exist")
    }
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    return res
        ...
        .json(new ApiResponse(200, { user: logedInUser, accessToken, refreshToken }, "user loggedin sucessfully"))
...
const logoutUser = asyncHandler(async (req, res) => {
    await User.findByIdAndUpdate(
        ...
        {
            returnDocument: 'after' // ✅ Modern Mongoose syntax
        }
    )
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res
            ...
            .cookie("accessToken", accessToken, options)
            .cookie("refreshToken", refreshToken, options)
            .json(new ApiResponse(200, { accessToken, newRefreshToken: refreshToken }, "Access token refreshed"))
    } catch (error) {
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    if (!avatar.url) {
        throw new ApiError(400, "error while uploadin n avatar")
    }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (currentUser.coverImage?.public_id) {
        await cloudinary.uploader.destroy(
            currentUser.coverImage.public_id
        );
    }
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user, "User cover image updated sucessfully"))
});
